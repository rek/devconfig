...
// SPDX-FileCopyrightText: 2015 Egmont Koblinger
//
...
/* File path with line number (and optional column), e.g. "src/foo.tsx:42" or "/home/user/bar.py:10:5" */
export const REGEX_FILE_LINE = '(?:~?\\.{0,2}/)?(?:[-\\w@.]+/)*[-\\w@.]+\\.(?:tsx?|jsx?|mjs|cjs|py|rs|go|java|[ch](?:pp)?|s?css|html?|json|ya?ml|toml|sh|sql|md|vue|svelte|rb|php|swift|kt|lua):\\d+(?::\\d+)?';
